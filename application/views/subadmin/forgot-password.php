...
<html lang="en" dir="ltr">
  <head>
		...
		<!-- Title -->
		<title>Forgot Password Branch Admin - Student Portal</title>
	...
	<body class="login-img">
										...
										<div class="card p-4">
											<div class="card-body">
												...
												<div class="row">
													...
													<div class="col-12">
														<a href="<?php echo base_url('subadmin/login'); ?>" class="btn btn-link box-shadow-0 px-0">Login?</a>
													</div>
												</div>
											</div>
										</div>
        ...
        <!-- Login js -->
        <script src="<?php echo base_url('assets/js/subadmin/login.js'); ?>"></script>
