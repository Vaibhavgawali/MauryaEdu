                ...
                <div class="card">
                    ...
                    <div class="card-body hero-feature">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                <td class="hidden-xs text-center">
                                                    <a href="javascript:void(0)">
                                                        <img src="<?php echo base_url() . "uploads/course/" . $cart_details[$i]['product_id'] . "/course-image/" . $cart_details[$i]['course_image']; ?>" alt="Metal Watch" title="" width="100" height="auto">
                                                    </a>
                                                </td>
                                                <td>
                                                ...
                                                <!-- <td><?php //echo $cart_details[$i]['course_sell_price'] ; 
                                                            ?></td>                                       -->
                                                <td class="text-center">
                                                    <a href="javascript:void(0)" class="remove_cart btn btn-sm btn-gradient-danger" product_id=<?php echo $cart_details[$i]['product_id']; ?>>
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                            <td colspan="2" class="text-center font-weight-bold">Enrollment Expiry Date <small class="text-primary">[After purchase]</small></td>
                        ...
                        <form name="razorpay-form" id="razorpay-form" action="<?php echo $callback_url; ?>" method="POST">
                            ...
                            <input type="hidden" name="card_holder_email_id" id="card_holder_email_id" value="<?php echo $email; ?>" />
                            <input type="hidden" name="card_holder_phone_id" id="card_holder_phone_id" value="<?php echo $phone; ?>" />
                            <input type="hidden" name="merchant_total" id="merchant_total" value="<?php echo $total; ?>" />
                            <input type="hidden" name="merchant_amount" id="merchant_amount" value="<?php echo $amount; ?>" />

                            <input type="hidden" name="discount_coupon_master_id" id="discount_coupon_master_id" value="<?php echo isset($cart_details[0]['discount_coupon_master_id']) ? $cart_details[0]['discount_coupon_master_id'] : ''; ?>" />
                            <input type="hidden" name="course_actual_price" id="course_actual_price" value="<?php echo isset($cart_details[0]['course_sell_price']) ? $cart_details[0]['course_sell_price'] : ''; ?>" />
                            <input type="hidden" name="price_after_discount" id="price_after_discount" value="<?php echo isset($cart_details[0]['price_after_discount']) ? $cart_details[0]['price_after_discount'] : ''; ?>" />
                            <input type="hidden" name="discount_type" id="discount_type" value="<?php echo isset($cart_details[0]['discount_type']) ? $cart_details[0]['discount_type'] : ''; ?>" />
                            <input type="hidden" name="disount_percent" id="disount_percent" value="<?php echo isset($cart_details[0]['disount_percent']) ? $cart_details[0]['disount_percent'] : ''; ?>" />
                            <input type="hidden" name="discount_value" id="discount_value" value="<?php echo isset($cart_details[0]['discount_value']) ? $cart_details[0]['discount_value'] : ''; ?>" />
                        ...
                        <div class="float-left mt-2">
                            ...
                            if (isset($cart_details) && count($cart_details) == 0) {
                            ?>
                                <a href="<?php echo base_url('student/courses-list'); ?>" class="btn btn-info mt-2 btn-md btn-gradient-success"><i class="fa fa-arrow-circle-left"></i> Continue Shopping</a>
                            <?php
                            }
                            ?>
