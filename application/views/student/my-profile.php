                                    ...
                                    <div class="card-body p-0">
                                        <div class="text-center">
                                            ...
                                            <div class="img-container border-primary p-3 " style="border-style: dashed; border-radius:8px;width:100% ">
                                                ...
                                                ">
                                                    <div class="w-100">
                                                        <img class='img_preview img-fluid' src="<?php echo $img_path; ?>"  alt="<?php echo $login_detail['full_name']; ?>">
                                                        <br>
                                ...
                                <div class="card">
                                    <div class="card-body p-0">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="exampleInputUsername2" placeholder="Username" disabled value="<?php echo $studentInfo['full_name']; ?>">
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                        ...
                                        <div class="form-group row mt-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="exampleInputUsername2" placeholder="Username" disabled value="<?php echo date('d-m-Y H:i:s', strtotime($studentInfo['created_date'])); ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row mt-3">
                            ...
                            <div class="col-12 py-2">
                                ...
                                <form action="">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="full_name" value="<?php echo $studentInfo['full_name']; ?>" class="form-control input-contact" placeholder="Enter Full Name" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="emailid">Email</label>
                                        <input type="email" class="form-control input-contact" id="emailid" placeholder="Email" value="<?php echo $studentInfo['emailid']; ?>" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="contact">Phone</label>
                                        <input type="text" class="form-control input-contact" id="contact" placeholder="Contact Number" value="<?php echo $studentInfo['contact']; ?>" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="aadhar_number">Aadhar Number</label>
                                        <input type="text" class="form-control input-contact" id="aadhar_number" placeholder="Aadhar Number" value="<?php echo isset($studentInfo['aadhar_number']) ? $studentInfo['aadhar_number'] : 'N/A'; ?>" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="address">Address</label>
                                        <textarea class="form-control input-contact" id="address" rows="4" placeholder="Enter Address" disabled><?php echo $studentInfo['address'] ? $studentInfo['address'] : 'N/A'; ?></textarea>
                                    </div>
                                    <div>
