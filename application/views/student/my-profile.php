                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    ...
                                    <img class='img_preview' src="<?php echo $img_path; ?>" width='300' height='300' alt="<?php echo $login_detail['full_name'];?>">
                                </div>
                                <br>
                                <div class="text-center">
                                    <h3 class="mb-0"><?php echo $studentInfo['full_name'];?></h3>
                                    <p class="text-muted mb-0"><?php echo $studentInfo['emailid'];?></p>
                                </div>
                                <hr>
                                <div class="text-left">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12 col-xl-12 text-left">
                                        <h2><?php echo $studentInfo['full_name'];?></h2>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-lg-8 col-xl-8 large-text mb-0"><?php echo $studentInfo['full_name'];?></div>
                                </div>
                                <div class="row mt-3">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-lg-8 col-xl-8 large-text mb-0"><?php echo date('d-m-Y H:i:s', strtotime($studentInfo['created_date']));?></div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-lg-4 col-xl-4 head-text">Updated On</div>
                                    <div class="col-lg-8 col-xl-8 large-text mb-0">
                                        <?php 
                                            if(!empty($studentInfo['updated_date'])){
                                                echo date('d-m-Y H:i:s', strtotime($studentInfo['updated_date']));
                                            }
                                            else{
                                                echo "-";
                                            }
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-lg-8 col-xl-8 large-text mb-0"><?php echo $studentInfo['emailid'];?></div>
                                </div>

                                <div class="row mt-3">
                                    <div class="col-lg-4 col-xl-4 head-text">Contact Number</div>
                                    <div class="col-lg-8 col-xl-8 large-text mb-0"><?php echo $studentInfo['contact'];?></div>
                                </div>

                                <div class="row mt-3">
                                    <div class="col-lg-4 col-xl-4 head-text">Address</div>
                                    <div class="col-lg-8 col-xl-8 large-text mb-0"><?php echo $studentInfo['address'];?></div>
                                </div>

                                <div class="row mt-3">
                                    <div class="col-lg-4 col-xl-4 head-text">Adhar Number</div>
                                    <div class="col-lg-8 col-xl-8 large-text mb-0"><?php echo $studentInfo['aadhar_number'];?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input  type="text" class="form-control"  id="full_name" maxlength="150" value="<?php echo $studentInfo['full_name'];?>" >
                                                </div>
                                            </div>

                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="focus-label" for="emailid">Email <?php if($studentInfo['role'] == 1) { echo "<span class='error-text'><sup>Contact Admin</sup></span>"; } else { echo "<span class='error-text'>*</span>"; } ?></label>
                                                    <input  type="text" class="form-control"  id="emailid" maxlength="150" value="<?php echo $studentInfo['emailid'];?>" <?php if($studentInfo['role'] == 1) { echo "disabled='disabled' readonly"; }?>>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input  type="text" class="form-control"  id="contact" maxlength="20" value="<?php echo $studentInfo['contact'];?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="address" class="form-control" rows="8" maxlength="500"><?php echo $studentInfo['address'];?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input  type="text" class="form-control"  id="aadhar_number" maxlength="12" value="<?php echo $studentInfo['aadhar_number'];?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
