                                        ...
                                        <?php
                                            ...
                                            <div class="img-container border-primary p-3 " style="border-style: dashed; border-radius:8px;width:100% ">
                                                ...
                                                <div>
                                                    ...
                                                    <a href="<?php echo base_url('admin/my-profile') ?>" class="btn btn-secondary btn-sm my-2 cancel-btn">Cancel</a>
                                                </div>
                                                <script>
                                ...
                                <div class="card">
                                    <div class="card-body p-0">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="exampleInputUsername2" placeholder="Username" disabled value="<?php echo $adminInfo['full_name']; ?>">
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                        ...
                                        <div class="form-group row mt-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="exampleInputUsername2" placeholder="Username" disabled value="<?php echo date('d-m-Y H:i:s', strtotime($adminInfo['createdOn'])); ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row mt-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="exampleInputUsername2" placeholder="Username" disabled value="<?php
                                                                                                                                                            if (!empty($adminInfo['updated_date'])) {
                                                                                                                                                                echo date('d-m-Y H:i:s', strtotime($admintInfo['updated_date']));
                                                                                                                                                            } else {
                                                                                                                                                                echo "-";
                                                                                                                                                            }
                                                                                                                                                            ?>">
                            ...
                            <div class="col-12 py-2">
                                ...
                                <form action="">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="full_name" value="<?php echo $adminInfo['full_name']; ?>" class="form-control input-contact" placeholder="Enter Full Name" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="emailid">Email</label>
                                        <input type="email" class="form-control input-contact" id="emailid" placeholder="Email" value="<?php echo $adminInfo['emailid']; ?>" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="contact">Phone</label>
                                        <input type="text" class="form-control input-contact" id="contact" placeholder="Contact Number" value="<?php echo $adminInfo['contact']; ?>" disabled>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control input-contact" id="address" rows="4" placeholder="Enter Address" disabled><?php echo $adminInfo['address'] ? $adminInfo['address'] : 'N/A'; ?></textarea>
                                    </div>
                                    <div>
