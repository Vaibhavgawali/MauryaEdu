                    ...
                    <div class="col-lg-5 col-xl-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <br>
                                <div class="text-center">
                                    <h3 class="mb-0"><?php echo $adminInfo['full_name'];?></h3>
                                    <p class="text-muted mb-0"><?php echo $adminInfo['emailid'];?></p>
                                </div>
                                <hr>
                                <div class="text-left">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12 col-xl-12 text-left">
                                        <h2><?php echo $adminInfo['full_name'];?></h2>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-lg-8 col-xl-8 large-text mb-0"><?php echo $adminInfo['full_name'];?></div>
                                </div>
                                <div class="row mt-3">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-lg-8 col-xl-8 large-text mb-0"><?php echo date('d-m-Y H:i:s', strtotime($adminInfo['createdOn']));?></div>
                                </div>
                                <div class="row mt-3">
                                    ...
                                    <div class="col-lg-8 col-xl-8 large-text mb-0">
                                        <?php 
                                            if(!empty($adminInfo['updated_date'])){
                                                echo date('d-m-Y H:i:s', strtotime($adminInfo['updatedOn']));
                                            }
                                            else{
                                                echo "-";
                                            }
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-lg-8 col-xl-8 large-text mb-0"><?php echo $adminInfo['emailid'];?></div>
                                </div>

                                <div class="row mt-3">
                                    <div class="col-lg-4 col-xl-4 head-text">Contact Number</div>
                                    <div class="col-lg-8 col-xl-8 large-text mb-0"><?php echo $adminInfo['contact'];?></div>
                                </div>

                                <div class="row mt-3">
                                    <div class="col-lg-4 col-xl-4 head-text">Address</div>
                                    <div class="col-lg-8 col-xl-8 large-text mb-0"><?php echo $adminInfo['address'];?></div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input  type="text" class="form-control"  id="full_name" maxlength="150" value="<?php echo $adminInfo['full_name'];?>" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input  type="text" class="form-control"  id="emailid" maxlength="150" value="<?php echo $adminInfo['emailid'];?>" <?php if($adminInfo['role'] == 1) { echo "disabled='disabled' readonly"; }?>>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input  type="text" class="form-control"  id="contact" maxlength="20" value="<?php echo $adminInfo['contact'];?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="address" class="form-control" rows="8" maxlength="500"><?php echo $adminInfo['address'];?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
