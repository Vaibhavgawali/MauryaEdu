...
<html lang="en" dir="ltr">
  <head>
		...
		<!-- Title -->
		<title>Forgot Password Admin - Student Portal</title>
									...
									<div class="card-group mb-0">
										<div class="card p-4">
											<div class="card-body">
												...
												<div class="row">
													<div class="col-12">
														<button type="button" class="btn btn-gradient-primary btn-block" id="btn_forgot_password_submit">Submit</button>
													</div>
													<div class="col-12">
														<a href="<?php echo base_url('admin/login'); ?>" class="btn btn-link box-shadow-0 px-0">Login?</a>
													</div>
												</div>
											</div>
										</div>
										<div class="card text-white bg-primary py-5 d-md-down-none login-transparent">
											<div class="card-body text-center justify-content-center ">
												...
												<a href="#" onclick="return false;" class="btn btn-gradient-success active mt-3">Register Now!</a>
											</div>
										</div>
									</div>
								</div>
