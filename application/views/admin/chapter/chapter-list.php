                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control p-3" id="course_master_id">
                                                        <option value="" selected>----- Select -----</option>
                                                    </select>
                                                </div>
                                            </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control p-3" id="update_course_master_id">
                                                        <option value="" selected>----- Select -----</option>
                                                        <?php
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="focus-label" for="update_chapter_name">Chapter Name <span class="text-danger">*</span> </label>
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control p-3" id="update_chapter_status">
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
