      ...
      <div class="col-xl-12 col-lg-12 col-md-12">
        <div class="card">
          <div class="card-body">
            ...
            <div class="modal fade" id="add-branch-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="row g-2">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="focus-label" for="branch_name">Branch <span class="text-danger">*</span> </label>
                    ...
                    <div class="row g-2">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="focus-label" for="branch_emailid">Email <span class="text-danger">*</span> </label>
                    ...
                    <div class="row g-2">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="focus-label" for="branch_contact">Contact <span class="text-danger">*</span> </label>
                    ...
                    <div class="row g-2">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="focus-label" for="branch_address">Address <span class="text-danger">*</span> </label>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="row g-2">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="focus-label" for="update_branch_name">Branch <span class="text-danger">*</span> </label>
                    ...
                    <div class="row g-2">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="focus-label" for="update_branch_emailid">Email <span class="text-danger">*</span> </label>
                    ...
                    <div class="row g-2">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="focus-label" for="update_branch_contact">Contact <span class="text-danger">*</span> </label>
                    ...
                    <div class="row g-2">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="focus-label" for="update_branch_address">Address <span class="text-danger">*</span> </label>
                    ...
                    <div class="row g-2">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <select class="form-control p-3" id="update_branch_status">
