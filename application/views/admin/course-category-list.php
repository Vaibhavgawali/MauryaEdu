                                ...
                                <div class="row g-2">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="focus-label" for="course_category_name">Course Category <span class="text">*</span> </label>
                ...
                <div id="update-course-category-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog"  role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <h6>Please fill all mandatory(<sup class="text">*</sup>) data</h6>
                                <hr>
                                ...
                                <div class="row g-2">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="focus-label" for="update_course_category_name">Course Category <span class="text">*</span> </label>
                                ...
                                <div class="row g-2">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control p-3"  id="update_course_category_status">
