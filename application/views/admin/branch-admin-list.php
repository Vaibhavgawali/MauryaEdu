...
<div class="page-header">
    <h4 class="page-title">Branch Admin</h4>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?php echo base_url('admin/dashboard'); ?>">Dashboard</a></li>
        <li class="breadcrumb-item active" aria-current="page">Branch Admin List</li>
    </ol>
</div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row g-2">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="focus-label" for="admin_name">Name <span class="error-text">*</span> </label>
                                ...
                                <div class="row g-2">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="focus-label" for="branch_id">Branch <span class="error-text">*</span> </label>
                                ...
                                <div class="row g-2">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="focus-label" for="admin_emailid">Email <span class="error-text">*</span> </label>
                                ...
                                <div class="row g-2">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="focus-label" for="admin_contact">Contact <span class="error-text">*</span> </label>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row g-2">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="focus-label" for="update_branch_admin_name">Name <span class="error-text">*</span> </label>
                                ...
                                <div class="row g-2">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="focus-label" for="update_branch_id">Branch <span class="error-text">*</span> </label>
                                            <select class="form-control"  id="update_branch_id">
                                                <option value="" selected>----- Select -----</option>
                                                <?php
                                                    for($i=0; $i<count($branch_list); $i++){
                                ...
                                <div class="row g-2">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="focus-label" for="update_branch_admin_emailid">Email <span class="error-text">*</span> </label>
                                ...
                                <div class="row g-2">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="focus-label" for="update_branch_admin_contact">Contact <span class="error-text">*</span> </label>
                                ...
                                <div class="row g-2">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control"  id="update_branch_admin_status">
                                                <?php
