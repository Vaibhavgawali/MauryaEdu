                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control p-3" id="course_category_id">
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="focus-label" for="course_name">Course Name <span class="text-danger">*</span> </label>
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="focus-label" for="course_info">Course Related General Information <span class="text-danger">*</span> <span class="text-warning">Add HTML content foe eg, <<br>br> for line break. <<b>b> for bold etc...</b>> </span> </label>
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="focus-label" for="course_image">Course Image <span class="text-danger">*</span> </label>
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="focus-label" for="course_actual_price">Actual Price <span class="text-danger">*</span> </label>
                                                    <input type="text" class="form-control" id="course_actual_price">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="focus-label" for="course_sell_price">Sell Price <span class="text-danger">*</span> </label>
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="focus-label" for="course_duration_number_of_days">Duration (Number of Days) <span class="text-danger">*</span> </label>
                                                    <input type="text" class="form-control" id="course_duration_number_of_days">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="focus-label" for="course_number_of_installments">Number of Installments<span class="text-danger">*</span> </label>
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="focus-label" for="course_start_date">Start Date <span class="text-danger">*</span> </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="focus-label" for="course_end_date">End Date <span class="text-danger">*</span> </label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                                                <i class="fa fa-calendar tx-16 lh-0 op-6"></i>
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="focus-label" for="is_allow_purchase_after_expire">Allow Purchase After Course Expiry Date <span class="text-danger">*</span> </label>
                                                    <select class="form-control p-3" id="is_allow_purchase_after_expire">
                                                        <option value="" selected>----Select----</option>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control p-3" id="update_course_category_id">
                                                        <option value="" selected>----- Select -----</option>
                                                        <?php
                                                        for ($i = 0; $i < count($course_category_list); $i++) {
                                                            echo "<option value='" . $course_category_list[$i]['course_category_id'] . "' >" . $course_category_list[$i]['course_category_name'] . "</option>";
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="focus-label" for="update_course_name">Course Name <span class="text-danger">*</span> </label>
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="focus-label" for="update_course_info">Course Related General Information <span class="text-danger">*</span> <span class="text-warning">Add HTML content foe eg, <<br>br> for line break. <<b>b> for bold etc...</b>> </span> </label>
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="focus-label" for="update_course_actual_price">Actual Price <span class="text-danger">*</span> </label>
                                                    <input type="text" class="form-control" id="update_course_actual_price">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="focus-label" for="update_course_sell_price">Sell Price <span class="text-danger">*</span> </label>
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="focus-label" for="update_course_duration_number_of_days">Duration (Number of Days) <span class="text-danger">*</span> </label>
                                                    <input type="text" class="form-control" id="update_course_duration_number_of_days">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="focus-label" for="update_course_number_of_installments">Number of Installments<span class="text-danger">*</span> </label>
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="focus-label" for="update_course_start_date">Start Date <span class="text-danger">*</span> </label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                                                <i class="fa fa-calendar tx-16 lh-0 op-6"></i>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="focus-label" for="update_course_end_date">End Date <span class="text-danger">*</span> </label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                                                <i class="fa fa-calendar tx-16 lh-0 op-6"></i>
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="focus-label" for="update_is_allow_purchase_after_expire">Allow Purchase After Course Expiry Date <span class="text-danger">*</span> </label>
                                                    <select class="form-control p-3" id="update_is_allow_purchase_after_expire">
                                                        <option value="0">No</option>
                                                        <option value="1">Yes</option>
                                                    </select>
                                                </div>
