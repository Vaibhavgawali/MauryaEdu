...
class StudentEnroll extends Front_Controller
{
    ...
    public function AddStudentEnroll($student_id = '')
    {
        ...
        addJs(array("admin/student-enroll-list.js"));
        ...
        $branch_filter = "branch_id IN (1," . $get_Student_Details['branch_id'] . ")";
        ...
        $this->load->admintemplate('enrollment/add-enrollment-details', $this->data);
    }
    ...
    public function StudentEnrollAddProcess()
    {
        ...
        $login_detail = $this->session->userdata('login_detail');
        $admin_id = $login_detail['userinfo_id'];
        ...
        if(!$get_Student_Details){
            ...
            $insert_array = array(
                ...
                'order_id' => $order_id,
                'amount' => $course_price,
                'payment_status' => ($installment_number === 1) ? "Paid" : "Pending",
