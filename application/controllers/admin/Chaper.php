...
class Chaper extends Front_Controller
{
    ...
    public function index()
    {
        ...
        addJs(array("admin/chaper-list.js"));
        ...
        $this->load->admintemplate('chapter/chapter-list', $this->data);
    }
    ...
    public function AddCourseChapter($course_master_id = '')
    {
        ...
        if(count($course_master_details) > 0){
            ...
            $this->load->admintemplate('chapter/add-chapter-details', $this->data);
        }
        else{
    ...
    public function ChaperListAjax()
    {
        ...
        foreach ($result as $main) {
            ...
            $add_chapter_content = "<a href='".base_url()."admin/chapter-data/".$chapter_master_id."' class='btn btn-info btn-sm' id='".$chapter_master_id."'><i class='fa fa-plus'></i> Add Chapter Data</a>";
