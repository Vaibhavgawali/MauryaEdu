...
class Student extends Front_Controller
{
    ...
    public function StudentListAjax()
    {
        ...
        foreach ($result as $main) {
            ...
            $enroll_button = "<a href='".base_url()."admin/enrollment-list/".$student_id."' class='btn btn-info btn-sm enroll_student' id='".$student_id."'><i class='fa fa-plus'></i> Enroll Now</a>";
