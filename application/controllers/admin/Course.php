...
class Course extends Front_Controller
{
    ...
    public function index()
    {
        ...
        addJs(array("admin/course-list.js"));
        ...
        $this->load->admintemplate('course-list', $this->data);
    }
    ...
    public function CourseListAjax()
    {
        ...
        $colums = array(
            ...
            3=>'bm.branch_name',
            4=>'cm.course_image',
            5=>'cm.course_start_date',
            6=>'cm.course_end_date',
        ...
        if (!empty($searchTerm)) {
            $where .= "AND (";
            $where .= " ccm.course_category_name like '%$searchTerm%' OR cm.course_name like '%$searchTerm%'  OR cm.course_duration_number_of_days like '%$searchTerm%' OR cm.course_actual_price like '%$searchTerm%' OR cm.course_sell_price like '%$searchTerm%' OR cm.course_number_of_installments like '%$searchTerm%' OR bm.branch_name like '%$searchTerm%'";
            $where .= ") ";
        }
        ...
        foreach ($result as $main) {
            ...
            $add_chapter_button = "<a href='".base_url()."admin/chapter-list/".$course_master_id."' class='btn btn-info btn-sm' id='".$course_master_id."'><i class='fa fa-plus'></i> Add Chapters</a>";
