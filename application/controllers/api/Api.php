    ...
    public function enrolled_course_list()
    {
        ...
        {   
            ...
            if($studentInfo)
            {
                ...
                {
                    $response = array('status' => false, 'message' => 'You have not purchased any course or your course is expired.', 'remaining_course' => 0);
                }
            }
            else
            {
        ...
        if($student_id != '' && $emailid != '')
        {
            ...
            if($login_detail)
            {
                ...
                if($totalData > 0)
                {
                    $json_data = array(
                        "status" => true,
                        "message" => "You have not purchased any course or your course is expired.",
