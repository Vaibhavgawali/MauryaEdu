...
class HolidayInformation extends Front_Controller
{
    ...
    public function index(){
        ...
        addJs(array("student/holiday-information.js"));
        ...
        $this->load->studenttemplate('holiday-information', $this->data);
    }
    ...
    public function HolidayInformationListAjax()
    {
        ...
        $colums = array(
            ...
            4=>'holiday_information_master.created_date',
            5=>'holiday_information_master.updated_date'
        ); 
