...
class Student extends Front_Controller
{
    ...
    public function index()
    {
        ...
        addJs(array("subadmin/student-list.js"));
        ...
        // print_r_custom($login_detail['branch_id'],1);
        $this->load->subadmintemplate('student-list', $this->data);
    }
    ...
    public function StudentListAjax()
    {
        ...
        if (!empty($searchTerm)) {
            $where .= " AND (";
            $where .= "sm.full_name like '%$searchTerm%'  or  sm.emailid like '%$searchTerm%' or sm.contact like '%$searchTerm%'";
            $where .= ") ";
        }
    ...
    public function StudentUpdateProcess()
    {
        ...
        if(empty($get_Student_Details)){
            ...
            $where = array('student_id' => $student_id,'branch_id'=>$branch_id);
