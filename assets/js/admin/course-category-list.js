$(document).ready(function () {
  ...
  $("#btn_add_course_category").click(function () {
    ...
    $.ajax({
      type: "post",
      url: base_url + "admin/course-category-add-process",
      dataType: "json",
      data: data,
      cache: false,
  ...
  var dataTable = $("#course_category_list").DataTable({
    ...
    serverSide: true,
    ajax: {
      url: base_url + "admin/course-category-list-ajax",
      cache: false,
  ...
  $("#course_category_list tbody").on(
    ...
    function () {
      ...
      $.ajax({
        type: "post",
        dataType: "json",
        url: base_url + "admin/get-course-category-detail",
  ...
  $("#btn_update_course_category").click(function () {
    ...
    $.ajax({
      type: "post",
      url: base_url + "admin/course-category-update-process",
      dataType: "json",
      data: data,
      cache: false,
      success: function (res) {
