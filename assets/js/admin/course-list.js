$(document).ready(function () {
  ...
  $("#btn_add_course").click(function () {
    ...
    $.ajax({
      type: "post",
      url: base_url + "admin/course-add-process",
      dataType: "json",
      data: form_data,
      contentType: false,
      processData: false,
  ...
  var dataTable = $("#course_list").DataTable({
    ...
    columnDefs: [{ orderable: false, targets: [0, 4, 11, 14] }],
    buttons: [
      {
        extend: "collection",
    ...
    serverSide: true,
    ajax: {
      url: base_url + "admin/course-list-ajax",
      cache: false,
  ...
  $("#course_list tbody").on("click", ".edit_course", function () {
    ...
    $.ajax({
      type: "post",
      dataType: "json",
      url: base_url + "admin/get-course-detail",
  ...
  $("#btn_update_course").click(function () {
    ...
    $.ajax({
      type: "post",
      url: base_url + "admin/course-update-process",
      dataType: "json",
      data: form_data,
      contentType: false,
      processData: false,
    ...
    $.confirm({
      ...
      buttons: {
        confirm: function () {
          ...
          $.ajax({
            type: "post",
            url: base_url + "admin/delete-course",
            dataType: "json",
            data: data,
            cache: false,
            success: function (res) {
