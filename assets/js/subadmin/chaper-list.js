$(document).ready(function () {
  ...
  $("#course_category_id, #update_course_category_id").change(function () {
    ...
    if (course_category_id != "") {
      ...
      $.ajax({
        type: "post",
        dataType: "json",
        url: base_url + "subadmin/get-course-list-from-category",
  ...
  $("#btn_add_chapter").click(function () {
    ...
    $.ajax({
      type: "post",
      url: base_url + "subadmin/chapter-add-process",
      dataType: "json",
      data: data,
      cache: false,
      success: function (res) {
        ...
        if (res.status == true) {
          ...
          setTimeout(function () {
            window.location.href = base_url + "subadmin/chapter-list/";
          }, 3500);
        } else {
  ...
  var dataTable = $("#chapter_list").DataTable({
    ...
    serverSide: true,
    ajax: {
      url: base_url + "subadmin/chapter-list-ajax",
      cache: false,
  ...
  $("#chapter_list tbody").on("click", ".edit_chaper", function () {
    ...
    $.ajax({
      type: "post",
      dataType: "json",
      url: base_url + "subadmin/get-chapter-detail",
  ...
  $("#btn_update_chapter").click(function () {
    ...
    $.ajax({
      type: "post",
      url: base_url + "subadmin/chapter-update-process",
      dataType: "json",
      data: data,
      cache: false,
      success: function (res) {
