$(document).ready(function () {
  ...
  var dataTable = $("#student_list").DataTable({
    ...
    serverSide: true,
    ajax: {
      url: base_url + "subadmin/student-list-ajax",
      cache: false,
  ...
  $("#student_list tbody").on("click", ".edit_student", function () {
    ...
    $.ajax({
      type: "post",
      dataType: "json",
      url: base_url + "subadmin/get-student-info",
  ...
  $("#btn_update_student").click(function () {
    ...
    $.ajax({
      type: "post",
      url: base_url + "subadmin/student-update-process",
      dataType: "json",
      data: data,
      cache: false,
      success: function (res) {
    ...
    $.confirm({
      ...
      buttons: {
        confirm: function () {
          ...
          $.ajax({
            type: "post",
            url: base_url + "subadmin/reset-student-password",
            dataType: "json",
            data: data,
            cache: false,
            success: function (res) {
    ...
    $.confirm({
      ...
      buttons: {
        confirm: function () {
          ...
          $.ajax({
            type: "post",
            url: base_url + "subadmin/delete-student",
            dataType: "json",
            data: data,
            cache: false,
            success: function (res) {
