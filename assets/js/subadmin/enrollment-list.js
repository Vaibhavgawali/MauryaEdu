$(document).ready(function () {
  ...
  $("#btn_add_certificate_details").click(function () {
    ...
    $.ajax({
      type: "post",
      url: base_url + "subadmin/certificate-add-process",
      dataType: "json",
      data: form_data,
      contentType: false,
      processData: false,
  ...
  $("#student_list tbody").on("click", ".edit_certificate", function () {
    ...
    $.ajax({
      type: "post",
      dataType: "json",
      url: base_url + "subadmin/get-certificate-details",
  ...
  $("#btn_update_certificate_details").click(function () {
    ...
    $.ajax({
      type: "post",
      url: base_url + "subadmin/certificate-update-process",
      dataType: "json",
      data: form_data,
      contentType: false,
      processData: false,
  ...
  $("#btn_add_id_card_details").click(function () {
    ...
    $.ajax({
      type: "post",
      url: base_url + "subadmin/id-card-add-process",
      dataType: "json",
      data: form_data,
      contentType: false,
      processData: false,
  ...
  $("#student_list tbody").on("click", ".edit_id_card", function () {
    ...
    $.ajax({
      type: "post",
      dataType: "json",
      url: base_url + "subadmin/get-id-card-details",
  ...
  $("#btn_update_id_card_details").click(function () {
    ...
    $.ajax({
      type: "post",
      url: base_url + "subadmin/id-card-update-process",
      dataType: "json",
      data: form_data,
      contentType: false,
      processData: false,
